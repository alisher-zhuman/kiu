...
interface Params {
  clearErrors: UseFormClearErrors<AddProfessorFormValues>;
  getValues: UseFormGetValues<AddProfessorFormValues>;
  setError: UseFormSetError<AddProfessorFormValues>;
  setValue: UseFormSetValue<AddProfessorFormValues>;
  t: (key: string) => string;
}

const checkIsImageFile = (file: File) => file.type.startsWith("image/");

export const useAddProfessorPhoto = ({
  clearErrors,
  getValues,
  setError,
  setValue,

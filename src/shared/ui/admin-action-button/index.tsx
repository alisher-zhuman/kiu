...
const VARIANT_CLASS_NAMES = {
  danger: "border-red-500/15 bg-red-500/6 text-red-600 hover:bg-red-500/10",
  neutral: "border-black/10 bg-black/3 text-black/70 hover:bg-black/5",
  primary: "border-[#004C97]/15 bg-[#004C97]/6 text-[#004C97] hover:bg-[#004C97]/10",
} as const;
    ...
    >
      {showIconOnly ? (
        <>
          ...
          {!iconOnly ? (
            <span className="hidden md:inline">{isPending ? pendingLabel : idleLabel}</span>
          ) : null}
        </>
      ) : isPending ? (
        pendingLabel

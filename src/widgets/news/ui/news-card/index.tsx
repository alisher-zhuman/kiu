...
export const NewsCard = ({ item, locale }: Props) => {
  ...
  return (
    ...
    >
      <article className="flex h-full flex-col overflow-hidden rounded-4xl border border-black/10 bg-white shadow-[0_18px_38px_rgba(0,0,0,0.05)] transition-shadow duration-300 hover:shadow-[0_24px_48px_rgba(0,0,0,0.08)]">
        {previewImage ? (
